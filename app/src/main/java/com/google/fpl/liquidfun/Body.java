...
public class Body {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        liquidfunJNI.delete_Body(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public Body(BodyDef bd, World world) {
    this(liquidfunJNI.new_Body(BodyDef.getCPtr(bd), bd, World.getCPtr(world), world), true);
  }

  public void synchronizeFixtures() {
    liquidfunJNI.Body_synchronizeFixtures(swigCPtr, this);
  }

  public void synchronizeTransform() {
    liquidfunJNI.Body_synchronizeTransform(swigCPtr, this);
  }

  public boolean shouldCollide(Body other) {
    return liquidfunJNI.Body_shouldCollide(swigCPtr, this, Body.getCPtr(other), other);
  }

  public void advance(float t) {
    liquidfunJNI.Body_advance(swigCPtr, this, t);
  }

  //public void setType(BodyType value) {
  //  liquidfunJNI.Body_type_set(swigCPtr, this, value.swigValue());
  //}

  //public BodyType getType() {
  //  return BodyType.swigToEnum(liquidfunJNI.Body_type_get(swigCPtr, this));
  //}

  public void setFlags(int value) {
    liquidfunJNI.Body_flags_set(swigCPtr, this, value);
  }

  public int getFlags() {
    return liquidfunJNI.Body_flags_get(swigCPtr, this);
  }

  public void setIslandIndex(int value) {
    liquidfunJNI.Body_islandIndex_set(swigCPtr, this, value);
  }

  public int getIslandIndex() {
    return liquidfunJNI.Body_islandIndex_get(swigCPtr, this);
  }

  public void setXf(Transform value) {
    liquidfunJNI.Body_xf_set(swigCPtr, this, Transform.getCPtr(value), value);
  }

  public Transform getXf() {
    return new Transform(liquidfunJNI.Body_xf_get(swigCPtr, this), false);
  }

  public void setXf0(Transform value) {
    liquidfunJNI.Body_xf0_set(swigCPtr, this, Transform.getCPtr(value), value);
  }

  public Transform getXf0() {
    return new Transform(liquidfunJNI.Body_xf0_get(swigCPtr, this), false);
  }

  public void setSweep(SWIGTYPE_p_b2Sweep value) {
    liquidfunJNI.Body_sweep_set(swigCPtr, this, SWIGTYPE_p_b2Sweep.getCPtr(value));
  }

  public SWIGTYPE_p_b2Sweep getSweep() {
    return new SWIGTYPE_p_b2Sweep(liquidfunJNI.Body_sweep_get(swigCPtr, this), true);
  }

  //public void setLinearVelocity(Vec2 value) {
  //  liquidfunJNI.Body_linearVelocity_set(swigCPtr, this, Vec2.getCPtr(value), value);
  //}

  //public Vec2 getLinearVelocity() {
  //  return new Vec2(liquidfunJNI.Body_linearVelocity_get(swigCPtr, this), false);
  //}

  //public void setAngularVelocity(float value) {
  //  liquidfunJNI.Body_angularVelocity_set(swigCPtr, this, value);
  //}

  //public float getAngularVelocity() {
  //  return liquidfunJNI.Body_angularVelocity_get(swigCPtr, this);
  //}

  public void setForce(Vec2 value) {
    liquidfunJNI.Body_force_set(swigCPtr, this, Vec2.getCPtr(value), value);
  }

  public Vec2 getForce() {
    return new Vec2(liquidfunJNI.Body_force_get(swigCPtr, this), false);
  }

  public void setTorque(float value) {
    liquidfunJNI.Body_torque_set(swigCPtr, this, value);
  }

  public float getTorque() {
    return liquidfunJNI.Body_torque_get(swigCPtr, this);
  }

  public void setWorld(World value) {
    liquidfunJNI.Body_world_set(swigCPtr, this, World.getCPtr(value), value);
  }

  //public World getWorld() {
  //  long cPtr = liquidfunJNI.Body_world_get(swigCPtr, this);
  //  return (cPtr == 0) ? null : new World(cPtr, false);
  //}

  public void setPrev(Body value) {
    liquidfunJNI.Body_prev_set(swigCPtr, this, Body.getCPtr(value), value);
  }

  public Body getPrev() {
    long cPtr = liquidfunJNI.Body_prev_get(swigCPtr, this);
    return (cPtr == 0) ? null : new Body(cPtr, false);
  }

  public void setNext(Body value) {
    liquidfunJNI.Body_next_set(swigCPtr, this, Body.getCPtr(value), value);
  }

  //public Body getNext() {
  //  long cPtr = liquidfunJNI.Body_next_get(swigCPtr, this);
  //  return (cPtr == 0) ? null : new Body(cPtr, false);
  //}

  public void setFixtureList(Fixture value) {
    liquidfunJNI.Body_fixtureList_set(swigCPtr, this, Fixture.getCPtr(value), value);
  }

  //public Fixture getFixtureList() {
  //  long cPtr = liquidfunJNI.Body_fixtureList_get(swigCPtr, this);
  //  return (cPtr == 0) ? null : new Fixture(cPtr, false);
  //}

  public void setFixtureCount(int value) {
    liquidfunJNI.Body_fixtureCount_set(swigCPtr, this, value);
  }

  public int getFixtureCount() {
    return liquidfunJNI.Body_fixtureCount_get(swigCPtr, this);
  }

  public void setJointList(SWIGTYPE_p_b2JointEdge value) {
    liquidfunJNI.Body_jointList_set(swigCPtr, this, SWIGTYPE_p_b2JointEdge.getCPtr(value));
  }

  //public SWIGTYPE_p_b2JointEdge getJointList() {
  // long cPtr = liquidfunJNI.Body_jointList_get(swigCPtr, this);
  //  return (cPtr == 0) ? null : new SWIGTYPE_p_b2JointEdge(cPtr, false);
  //}

  public void setContactList(SWIGTYPE_p_b2ContactEdge value) {
    liquidfunJNI.Body_contactList_set(swigCPtr, this, SWIGTYPE_p_b2ContactEdge.getCPtr(value));
  }

  //public SWIGTYPE_p_b2ContactEdge getContactList() {
  //  long cPtr = liquidfunJNI.Body_contactList_get(swigCPtr, this);
  //  return (cPtr == 0) ? null : new SWIGTYPE_p_b2ContactEdge(cPtr, false);
  //}

  public void setMass(float value) {
    liquidfunJNI.Body_mass_set(swigCPtr, this, value);
  }

  //public float getMass() {
  //  return liquidfunJNI.Body_mass_get(swigCPtr, this);
  //}

  public void setInvMass(float value) {
    liquidfunJNI.Body_invMass_set(swigCPtr, this, value);
  }

  public float getInvMass() {
    return liquidfunJNI.Body_invMass_get(swigCPtr, this);
  }

  public void setI(float value) {
    liquidfunJNI.Body_I_set(swigCPtr, this, value);
  }

  public float getI() {
    return liquidfunJNI.Body_I_get(swigCPtr, this);
  }

  public void setInvI(float value) {
    liquidfunJNI.Body_invI_set(swigCPtr, this, value);
  }

  public float getInvI() {
    return liquidfunJNI.Body_invI_get(swigCPtr, this);
  }

  //public void setLinearDamping(float value) {
  //  liquidfunJNI.Body_linearDamping_set(swigCPtr, this, value);
  //}

  //public float getLinearDamping() {
  //  return liquidfunJNI.Body_linearDamping_get(swigCPtr, this);
  //}

  //public void setAngularDamping(float value) {
  //  liquidfunJNI.Body_angularDamping_set(swigCPtr, this, value);
  //}

  //public float getAngularDamping() {
  //  return liquidfunJNI.Body_angularDamping_get(swigCPtr, this);
  //}

  //public void setGravityScale(float value) {
  //  liquidfunJNI.Body_gravityScale_set(swigCPtr, this, value);
  //}

  //public float getGravityScale() {
  //  return liquidfunJNI.Body_gravityScale_get(swigCPtr, this);
  //}

  public void setSleepTime(float value) {
    liquidfunJNI.Body_sleepTime_set(swigCPtr, this, value);
  }

  public float getSleepTime() {
    return liquidfunJNI.Body_sleepTime_get(swigCPtr, this);
  }

  public final static int e_islandFlag = 0x0001;
  public final static int e_awakeFlag = 0x0002;
  public final static int e_autoSleepFlag = 0x0004;
  public final static int e_bulletFlag = 0x0008;
  public final static int e_fixedRotationFlag = 0x0010;
  public final static int e_activeFlag = 0x0020;
  public final static int e_toiFlag = 0x0040;
